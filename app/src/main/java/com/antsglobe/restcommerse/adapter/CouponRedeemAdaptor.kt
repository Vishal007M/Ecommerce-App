...
import com.antsglobe.restcommerse.databinding.CouponRedeemRecyclerViewBinding
...
class CouponRedeemAdaptor(val items: List<Coupon?>) :
    RecyclerView.Adapter<CouponRedeemAdaptor.MainViewHolder>() {

    inner class MainViewHolder(val itemsBinding: CouponRedeemRecyclerViewBinding) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MainViewHolder {
        return MainViewHolder(
            CouponRedeemRecyclerViewBinding.inflate(
