...
import com.antsglobe.restcommerse.databinding.FragmentShippingBinding
...
class Shipping : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if (sharedPreferences.getMode() == true) {
            ...
            binding.ShippingPolicy.setBackgroundColor(resources.getColor(R.color.black))
            ...
            binding.t12.setTextColor(resources.getColor(R.color.dark_grey))
            binding.t1.setText(R.string.shipping1dark)
            binding.t2.setText(R.string.shipping2dark)
            binding.t3.setText(R.string.shipping3dark)
            binding.t4.setText(R.string.shipping4dark)
            binding.t5.setText(R.string.shipping5dark)
            binding.t6.setText(R.string.shipping6dark)
            binding.t7.setText(R.string.shipping7dark)
            binding.t8.setText(R.string.shipping8dark)
            binding.t9.setText(R.string.shipping9dark)
            binding.t10.setText(R.string.shipping10dark)
            binding.t11.setText(R.string.shipping11dark)
            binding.t12.setText(R.string.shipping12dark)
        }
